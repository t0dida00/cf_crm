    ...
    <>
      ...
      <Card className="overflow-hidden">
        <CardContent className="px-0">
          <div className="grid grid-cols-[90px_minmax(160px,1fr)_120px_150px_130px] gap-3 border-b bg-secondary px-5 py-3 text-xs font-semibold tracking-wide text-muted-foreground uppercase">
            <span>Time</span>
            <span>Guest</span>
            <span>Party</span>
            <span>Table</span>
          ...
          {bookings.length === 0 ? (
            ...
            bookings.map((b) => (
              <button
                ...
                className="grid w-full grid-cols-[90px_minmax(160px,1fr)_120px_150px_130px] items-center gap-3 border-b px-5 py-3.5 text-left transition-colors last:border-0 hover:bg-secondary"
              >
                <span className="text-[15px] font-bold">{b.time}</span>
